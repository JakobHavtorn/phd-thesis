...
\begin{sidewaystable*}[t]
    \caption{Selected latent variable models classified according the attributes defined throughout section \ref{sec:plvms}. See table~\ref{tab:lvm-model-primitives} for the probability distributions that correspond to each of the attribute short-hands. \textbf{\textsc{hie}} indicates a hierarchical representation.}
