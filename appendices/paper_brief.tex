...
\begin{figure}[!t]
    ...
    \begin{tabular}{>{\centering\arraybackslash} m{4mm}  >{\centering\arraybackslash} m{0.45\textwidth}|>{\centering\arraybackslash} m{0.45\textwidth}}
        ...
        %\midrule
        \rotatebox{90}{{\small \textsc{reconstruct}}} & \includegraphics[width=0.45\textwidth]{paper_brief/REC_PRD.pdf} & \includegraphics[width=0.45\textwidth]{paper_brief/REC_MSK.pdf}  \\
        \midrule
        \rotatebox{90}{{\small \textsc{contrastive}}} & \includegraphics[width=0.45\textwidth]{paper_brief/CON_PRD.pdf} & \includegraphics[width=0.45\textwidth]{paper_brief/CON_MSK.pdf}
    \end{tabular}
    \caption{
