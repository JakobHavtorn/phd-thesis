...
\makechapterstyle{mychapterstyle}{
    ...
    \renewcommand*{\chapnumfont}{\format\fontsize{20}{20}\fontfamily{eulervm}\selectfont}  % font for chapter number
    \renewcommand*{\chaptitlefont}{\format\fontsize{18}{18}\fontshape{sc}\selectfont}  % font for chapter title
