...
\renewcommand{\cftpartfont}{\small\color{dtured}\scshape\MakeLowercase}  % \part font in ToC
\renewcommand{\cftchapterfont}{\small\scshape}             % \chapter font in ToC
...
% \renewcommand{\cftpartfont}{\color{dtured}\MakeUppercase}%
% \renewcommand{\cftpartpagefont}{\partnumfont}%
...
\renewcommand*{\partnumfont}{\normalfont\bfseries\scshape}  % font for part number
