...
\makechapterstyle{mychapterstyle}{
    ...
    \renewcommand*{\chapnamefont}{\format\fontshape{sc}\selectfont}
    \renewcommand*{\chapnumfont}{\format\fontsize{30}{30}\fontshape{sc}\selectfont}
    \renewcommand*{\chaptitlefont}{\format\fontsize{24}{24}\fontshape{sc}\selectfont}
