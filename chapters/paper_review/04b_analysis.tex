...
In \cite{pasad2021} wav2vec~2.0 representations were analyzed with
...
\cite{pasad2021} further show that fine-tuning the pre-trained model with a
...
acoustic and phonetic information. In a recent study~\cite{chen2021wavlm} the
...
larger datasets~\cite{rivi20, kawakami2020learning, chen2021wavlm}. For
example,
...
experiments with larger and more diverse data collections~\cite{chen2021wavlm}
...
model~\cite{liu2020mockingjay}, the authors in \cite{pue2021scaling} attempt to establish a relationship between
