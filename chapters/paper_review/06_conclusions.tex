...
The prompt/instruction learning methods~\cite{liu2021pretrain} also freeze the SSL parameters and control the output of SSL by adding additional information, which is called \textit{prompt}, in the input.
...
Speech SSL models show strengths on a surprisingly wide range of tasks~\cite{yang21c_interspeech}, suggesting that representations contain different information.
