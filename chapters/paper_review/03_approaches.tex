...
%\item VAE, VQ-VAE
    ...
    \item Two dropout regularization methods, attention dropout and layer dropout, are introduced to TERA~\cite{luo_drop_2021}. 
\end{itemize}
\end{comment}
