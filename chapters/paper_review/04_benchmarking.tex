...
representations~\cite{kawakami_learning_2020}. The Fisher corpus~\cite{cieri2004fisher} collects
...
pre-training~\cite{kawakami_learning_2020, song_speech-xlnet_2020, babu2021xlsr}.
...
\cite{quitry_learning_2019} employs the NSynth dataset~\cite{engel2017neural} on top
...
% \textbf{Multi}: multilinguality; 
  ...
  \begin{tabular}{llllll}
    ...
    Common Voice (CV-dataset) & PT/EV & Multi & 11k/7k \cite{babu2021xlsr}/430 \cite{kawakami_learning_2020} & ASR/PR/PC & CC0 \\ \hline % mention the split, CPC-modified, Bidir-CPC
...
\begin{table*}[ht]
  ...
  \begin{tabular}{p{0.12\textwidth}p{0.12\textwidth}p{0.06\textwidth}p{0.13\textwidth}p{0.13\textwidth}p{0.06\textwidth}p{0.20\textwidth}}
    ...
    % PASE+
    \multirow{3}{*}[0mm]{PASE+\cite{ravanelli_multi-task_2020}} & \multirow{3}{*}[0mm]{LS 50 hrs \cite{ravanelli2018learning}} & PR & TIMIT\textsuperscript{\ref{footnote:official-split}} & TIMIT\textsuperscript{\ref{footnote:official-split}} & \checkmark & 4 hrs \\ \cline{3-7}
...
\begin{table*}[ht]
  ...
  \begin{tabular}{p{0.12\textwidth}p{0.12\textwidth}p{0.05\textwidth}p{0.18\textwidth}p{0.18\textwidth}p{0.05\textwidth}p{0.15\textwidth}}
    ...
    % speech-XLNet
    \multirow{2}{*}[-1mm]{speech-XLNet \cite{song_speech-xlnet_2020}} & \multirow{2}{*}[-1mm]{\makecell[l]{LS 960 hrs\\\;\;\;+ WSJ si284\\\;\;\;+ TED2}} & PR & TIMIT\textsuperscript{\ref{footnote:official-split}} & TIMIT\textsuperscript{\ref{footnote:official-split}} & \checkmark & 4 hrs\vspace{1mm} \\ \cline{3-7}
    ...
    & & PR & TIMIT\textsuperscript{\ref{footnote:official-split}} & TIMIT\textsuperscript{\ref{footnote:official-split}} & \checkmark & 4 hrs \\ \hline
    % NPC
    \multirow{2}{*}[0mm]{NPC \cite{liu_non-autoregressive_2020}} & \multirow{2}{*}[0mm]{LS 360 hrs} & PC & WSJ si284\textsuperscript{\ref{footnote:91-split-dev}} & \makecell[l]{WSJ dev93} & \checkmark & \makecell[l]{81 hrs} \\ \cline{3-7}
    & & SID & WSJ si284\textsuperscript{\ref{footnote:APC-split}} & WSJ si284\textsuperscript{\ref{footnote:APC-split}} & \checkmark & 65\textsuperscript{\ref{footnote:low-resource}} hrs \\ \hline
    % DeCoAR 2.0
...
\cite{tagliasacchi_pretraining_2020} are MUSAN~\cite{snyder2015musan}, Bird Audio
...
\cite{quitry_learning_2019} use the NSynth dataset~\cite{engel2017neural} for
evaluation.}
\addtocounter{footnote}{1}
...
multilinguality~\cite{kawakami_learning_2020, babu2021xlsr} are also gaining
