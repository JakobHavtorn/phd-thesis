...
Last, \parencite{tagliasacchi_pretraining_2020} puts together five datasets 
(MUSAN~\parencite{snyder_musan_2015}, Bird Audio Detection \parencite{stowell_automatic_2019},
Speech Commands~\parencite{warden_speech_2018}, Spoken Language 
Identification~\parencite{oponowicz_spoken_2018}, and TUT Urban Acoustic Scenes 2018~\parencite{mesaros_detection_2018}) plus
...
\parencite{quitry_learning_2019} employs the NSynth dataset~\parencite{engel_neural_2017} on top
...
\begin{table*}[t]
  ...
  dataset is used to evaluate. Abbrevations are listed in \cref{footnote:table:datasets-abbrevations}.}
  ...
  \begin{tabular}{llllll}
    ...
    Fisher & PT & EN & 2k/1k \parencite{jiang_further_2021}  & - & Linguistic Data Consortium (LDC) \\ \hline % MPC
    ...
    Common Voice (CV-dataset) & PT/EV & Multi & 11k/7k \parencite{babu_xlsr_2021}/430 \parencite{kawakami_learning_2020} & ASR/PR/PC & CC0 \\ \hline % mention the split, CPC-modified, Bidir-CPC
    Multilingual LS (MLS) & PT/EV & Multi & 50k & ASR & CC BY 4.0 \\ \hline
    VoxPopuli (VP) & PT/EV & Multi & 400k \parencite{babu_xlsr_2021}/24k \parencite{chen_unispeechsat_2021, chen_wavlm_2021} & ASR & CC0 \\ \hline
    BABEL (BBL) & PT/EV & Multi & 1k & ASR & IARPA Babel Agreement  \\ \hline

    GigaSpeech & PT/EV & EN & 40k/10k \parencite{chen_unispeechsat_2021, chen_wavlm_2021} & ASR & Apache-2.0 License \\ \hline
...
\footnotetext{\label{footnote:table:datasets-abbrevations}
In \cref{table:datasets}, we use the following abbreviations:
\textbf{EN}: English; 
...
\begin{table*}
  ...
  evaluations (Part 1). 
  Networks are usually pre"=trained with SSL
  techniques, augmented with prediction heads, and fine"=tuned (or trained) with
  labeled data in downstream tasks for benchmarking. 
  We follow the abbreviations introduced in \cref{table:datasets}.
  Column descriptions are in \cref{footnote:table:method_data_setting}.
  }
  \label{table:method_data_setting}
  \resizebox*{0.99\textwidth}{!}{%
  {%\tabulinesep=1mm
  \renewcommand*\arraystretch{1.4}
  \begin{tabular}{p{0.14\textwidth}p{0.12\textwidth}p{0.06\textwidth}p{0.15\textwidth}p{0.10\textwidth}p{0.05\textwidth}p{0.15\textwidth}}
    \toprule
    ...
    \midrule
    % CPC
    \multirow{2}{*}[0mm]{CPC \parencite{oord_representation_2018}} & \multirow{2}{*}[0mm]{LS 100 hrs} & PC & LS 100 hrs\textsuperscript{\ref{footnote:CPC-split}} & LS 100 hrs\textsuperscript{\ref{footnote:CPC-split}} & - & 80\textsuperscript{\ref{footnote:low-resource}} hrs \\ \cline{3-7}
    ...
    % PASE
    \multirow{2}{*}[-5mm]{PASE\parencite{pascual_learning_2019}} & \multirow{2}{*}[-5mm]{LS 50 hrs \parencite{ravanelli_learning_2018}} & SID & VCTK\textsuperscript{\ref{footnote:official-split}} & VCTK\textsuperscript{\ref{footnote:official-split}} & \checkmark & 44 hrs \\ \cline{3-7}
    ...
    % APC
    \multirow{3}{*}[0mm]{APC \parencite{chung_unsupervised_2019, chung_generative_2020}} & \multirow{3}{*}[0mm]{LS 360 hrs} & ASR & WSJ si284\textsuperscript{\ref{footnote:91-split-dev}} & WSJ dev93 & \checkmark & 72 hrs \\ \cline{3-7}
    ...
    % wav2vec
    \multirow{2}{*}[0mm]{wav2vec \parencite{schneider_wav2vec_2019}} & \multirow{2}{*}[-0.5mm]{\makecell[l]{LS 80/960 hrs,\\ LS 960 hrs \\ \:+ WSJ si284}} & ASR & WSJ si284 & WSJ eval92 & \checkmark & 81 hrs\vspace{1mm} \\ \cline{3-7}
    ...
    % Bidir-CPC
    \multirow{3}{*}{Bidir-CPC\parencite{kawakami_learning_2020}} & \multirow{3}{*}{\makecell[l]{LS 960 hrs,\\ CPC-8k\textsuperscript{\ref{footnote:CPC-8k}}}} & ASR & \makecell[l]{WSJ si284,\\LS 960 hrs,\\TED3\textsuperscript{\ref{footnote:official-split}}} & \makecell[l]{WSJ eval92,\\LS test-clean,\\LS test-other,\\TED3\textsuperscript{\ref{footnote:official-split}}, SWB\textsuperscript{\ref{footnote:official-split}}}  & \makecell[l]{Different\\ datasets for\\ training\\ and test} & 81/960/450 hrs \\ \cline{3-7} % cross domain transferring, SWB eval2000, TED3 training set size = 450 hrs
    ...
    % vq-VAE
    % MockingJay
    \multirow{3}{*}{MockingJay \parencite{liu_mockingjay_2020}} & \multirow{3}{*}{\makecell[l]{LS 360 hrs}} & PC & LS 360 hrs & LS test-clean & - & 0.36\textsuperscript{\ref{footnote:low-resource}} /1.8\textsuperscript{\ref{footnote:low-resource}} /3.6\textsuperscript{\ref{footnote:low-resource}} /18\textsuperscript{\ref{footnote:low-resource}} /45\textsuperscript{\ref{footnote:low-resource}} /360  hrs \\ \cline{3-7}
    ...
    % CPC modified
    \multirow{2}{*}{CPC modified \parencite{riviere_unsupervised_2020}} & LS 100 hrs & PC & LS 100 hrs\textsuperscript{\ref{footnote:CPC-split}} & \makecell[l]{LS 100 hrs\textsuperscript{\ref{footnote:CPC-split}}} & - & \makecell[l]{80\textsuperscript{\ref{footnote:low-resource}} hrs} \\ \cline{2-7}
    ...
    % vq-wav2vec
    \multirow{2}{*}[0mm]{vq-wav2vec \parencite{baevski_vqwav2vec_2020}} & \multirow{2}{*}[0mm]{LS 960 hrs} & ASR & WSJ si284 & \makecell[l]{WSJ eval92} & \checkmark & \makecell[l]{81 hrs} \\ \cline{3-7}
    ...
    % DeCoAR
    \multirow{2}{*}[0mm]{DeCoAR \parencite{ling_deep_2020}} & \multirow{2}{*}[0mm]{\makecell[l]{LS 100/360/\\\:\:\:460/960 hrs,\\ WSJ si284}} & ASR & WSJ si284 & WSJ eval92 & - & \makecell[l]{25\textsuperscript{\ref{footnote:low-resource}}/40\textsuperscript{\ref{footnote:low-resource}}/81 hrs} \\ \cline{3-7}
...
\addtocounter{footnote}{1}
\footnotetext{\label{footnote:table:method_data_setting}
  The \textbf{pre"=training corpus}, \textbf{Fine"=tuning}, and
  \textbf{Test} columns list the datasets used in each work, and the \textbf{Task}
  column lists the tasks performed in the corresponding papers. 
  The \textbf{Transfer} column indicates whether the SSL technique is evaluated by its capability for
...
\begin{table*}
  ...
  \begin{tabular}{p{0.14\textwidth}p{0.12\textwidth}p{0.06\textwidth}p{0.15\textwidth}p{0.10\textwidth}p{0.05\textwidth}p{0.15\textwidth}}
    ...
    \midrule
    % BMR
    \multirow{2}{*}[0mm]{BMR \parencite{wang_unsupervised_2020}} & \multirow{2}{*}[0mm]{\makecell[l]{WSJ si284,\\LS 960 hrs}} & ASR & WSJ si284 & WSJ eval92 & - & 81 hrs \\ \cline{3-7}
    & & PR & WSJ si84/si284 & WSJ dev93 & - & 15/81 hrs \\ \hline
    % vq-APC
    \multirow{2}{*}[0mm]{vq-APC \parencite{chung_vectorquantized_2020}} & \multirow{2}{*}[0mm]{LS 360 hrs} & PC & WSJ si284\textsuperscript{\ref{footnote:91-split-dev}} & \makecell[l]{WSJ dev93} & \checkmark & \makecell[l]{81 hrs} \\ \cline{3-7}
    & & SID & WSJ si284\textsuperscript{\ref{footnote:APC-split}} & WSJ si284\textsuperscript{\ref{footnote:APC-split}} & \checkmark & 65\textsuperscript{\ref{footnote:low-resource}} hrs \\ \hline
    % vq-wav2vec + Discrete BERT
    \makecell[l]{vq-wav2vec + \\DiscreteBERT \parencite{baevski_effectiveness_2020}} & LS 960 hrs & ASR & LS 100 hrs & \makecell[l]{LS test-clean,\\ LS test-other} & - & \makecell[l]{10 mins\textsuperscript{\ref{footnote:low-resource}},\\ 1\textsuperscript{\ref{footnote:low-resource}}/10\textsuperscript{\ref{footnote:low-resource}}/100 hrs} \\ \hline
    % speech-XLNet
    \multirow{2}{*}[-1mm]{speech-XLNet \parencite{song_speechxlnet_2020}} & \multirow{2}{*}[-1mm]{\makecell[l]{LS 960 hrs\\\;\;\;+ WSJ si284\\\;\;\;+ TED2}} & PR & TIMIT\textsuperscript{\ref{footnote:official-split}} & TIMIT\textsuperscript{\ref{footnote:official-split}} & \checkmark & 4 hrs\vspace{1mm} \\ \cline{3-7}
    ...
    % MPC
    \multirow{3}{*}[0mm]{MPC \parencite{jiang_improving_2019, jiang_further_2021}} & \multirow{2}{*}[0mm]{\makecell[l]{Didi Callcenter,\\Didi Dictation,\\Open Mandarin}} & ASR-zh & HKUST\textsuperscript{\ref{footnote:official-split}} & HKUST\textsuperscript{\ref{footnote:official-split}} & \checkmark & 168 hrs \\ \cline{3-7}
    ...
    % MPE
    \multirow{2}{*}[0mm]{MPE \parencite{liu_masked_2020}} & \multirow{2}{*}[0mm]{\makecell[l]{WSJ si284,\\LS 960 hrs}} & ASR & WSJ si284 & WSJ eval92 & - & \makecell[l]{25\textsuperscript{\ref{footnote:low-resource}}/40\textsuperscript{\ref{footnote:low-resource}}/81 hrs} \\ \cline{3-7}
    & & ASR & LS 100/360/960 hrs & LS test-clean & - & 100/360/960 hrs \\ \hline
    % ConvDMM
    ConvDMM \parencite{khurana_convolutional_2020} & \makecell[l]{LS 50\parencite{ravanelli_learning_2018}/360/\\\:\:\:960 hrs} & PC/PR & WSJ si284 & WSJ eval92 & \checkmark & \makecell[l]{5\textsuperscript{\ref{footnote:low-resource}}/50\textsuperscript{\ref{footnote:low-resource}}/100\textsuperscript{\ref{footnote:low-resource}} mins,\\ 4\textsuperscript{\ref{footnote:low-resource}}/8\textsuperscript{\ref{footnote:low-resource}}/40\textsuperscript{\ref{footnote:low-resource}} hrs} \\ \hline
    % wav2vec 2.0
    \multirow{2}{*}{wav2vec 2.0 \parencite{baevski_wav2vec_2020}} & \multirow{2}{*}{\makecell[l]{LS 960 hrs,\\ LL 60k hrs}} & ASR & LS 960 hrs & \makecell[l]{LS test-clean,\\ LS test-other} & - & \makecell[l]{10 mins\textsuperscript{\ref{footnote:low-resource}},\\ 1\textsuperscript{\ref{footnote:low-resource}}/10\textsuperscript{\ref{footnote:low-resource}}/100/960 hrs} \\ \cline{3-7}
    & & PR & TIMIT\textsuperscript{\ref{footnote:official-split}} & TIMIT\textsuperscript{\ref{footnote:official-split}} & \checkmark & 4 hrs \\ \hline
    % NPC
    \multirow{2}{*}[0mm]{NPC \parencite{liu_nonautoregressive_2020}} & \multirow{2}{*}[0mm]{LS 360 hrs} & PC & WSJ si284\textsuperscript{\ref{footnote:91-split-dev}} & \makecell[l]{WSJ dev93} & \checkmark & \makecell[l]{81 hrs} \\ \cline{3-7}
    & & SID & WSJ si284\textsuperscript{\ref{footnote:APC-split}} & WSJ si284\textsuperscript{\ref{footnote:APC-split}} & \checkmark & 65\textsuperscript{\ref{footnote:low-resource}} hrs \\ \hline
    % DeCoAR 2.0
    DeCoAR 2.0 \parencite{ling_decoar_2020} & LS 960 hrs & ASR & \makecell[l]{LS 100 hrs} & \makecell[l]{LS test-clean,\\ LS test-other} & - & \makecell[l]{1\textsuperscript{\ref{footnote:low-resource}}/10\textsuperscript{\ref{footnote:low-resource}}/100 hrs} \\ \hline
    % TERA
    \multirow{4}{*}[0mm]{TERA \parencite{liu_tera_2021}} & \multirow{4}{*}[0mm]{\makecell[l]{LS 100/360/\\\:\:\:960 hrs}} & PC & LS 100 hrs\textsuperscript{\ref{footnote:CPC-split}} & LS 100 hrs\textsuperscript{\ref{footnote:CPC-split}} & - & 80\textsuperscript{\ref{footnote:low-resource}} hrs \\ \cline{3-7}
    ...
    % HuBERT
    HuBERT \parencite{hsu_hubert_2021} & \makecell[l]{LS 960 hrs,\\ LL 60k hrs} & ASR & LS 960 hrs & \makecell[l]{LS test-clean\\ LS test-other} & - & \makecell[l]{10 mins\textsuperscript{\ref{footnote:low-resource}}, 1\textsuperscript{\ref{footnote:low-resource}}\\/10\textsuperscript{\ref{footnote:low-resource}}/100/960 hrs} \\ \hline
    % wav2vec-c
    wav2vec-c \parencite{sadhu_wav2vecc_2021} & Alexa-10k & ASR & \makecell[l]{Alexa-eval} & \makecell[l]{Alexa-eval} & \checkmark & 1k hrs \\ \hline
    UniSpeech-SAT \parencite{chen_unispeechsat_2021} & \makecell[l]{LL 60k hrs\\\;\;+ GigaSpeech-10k\\\;\;+ VP-24k} & Multi & SUPERB & SUPERB & \checkmark & See SUPERB \parencite{yang_superb_2021} paper for details \\ \hline
    WavLM \parencite{chen_wavlm_2021} & \makecell[l]{LL 60k hrs\\\;\;+ GigaSpeech-10k\\\;\;+ VP-24k} & Multi & SUPERB & SUPERB & \checkmark & See \parencite{yang_superb_2021} for details \\ \hline
    \multirow{4}{*}[0mm]{XLS-R \parencite{babu_xlsr_2021}} & \multirow{4}{*}[0mm]{\makecell[l]{VP-400k + MLS\\\;\;+ CV-dataset-7k\\\;\;+ VL\\\;\;+ BBL}} & ASR & \makecell[l]{VP, MLS,\\CV-dataset,\\BBL, LS} & \makecell[l]{VP, MLS,\\CV-dataset,\\BBL, LS} & - & \multirow{4}{*}[0mm]{See \parencite{babu_xlsr_2021} for details} \\ \cline{3-6}
...
by \parencite{oord_representation_2018} on Google drive
...
\parencite{tagliasacchi_pretraining_2020} are MUSAN~\parencite{snyder_musan_2015}, Bird Audio
Detection~\parencite{stowell_automatic_2019}, Speech Commands~\parencite{warden_speech_2018},
Spoken Language Identification~\parencite{oponowicz_spoken_2018}, TUT Urban Acoustic
Scenes 2018~\parencite{mesaros_detection_2018} plus an SID task built with LS
\textit{train-clean-100}. In addition to the 6 datasets,
\parencite{quitry_learning_2019} use the NSynth dataset~\parencite{engel_neural_2017} for
evaluation.}
\addtocounter{footnote}{1}
\footnotetext{\label{footnote:CPC-8k}
A collection of AudioSet, AVSpeech,
CV-dataset, LS, WSJ, TIMIT, Speech Accent Archive 
(SSA)~\parencite{weinberger_speech_2011}, TED3, and SWB. SSA is a growing annotated corpus of
English speech with various accents. Among the papers studied in this review, SSA
is used in \parencite{kawakami_learning_2020} only for pre"=training, and only 1 hour
...
\begin{figure*}
\centering
\includegraphics[width=\textwidth]{paper_review/ls-test-clean-v2.pdf}
...
publication. We also compare with baselines including the log Mel filter bank (fBANK) and semi"=supervised, self-training
approaches (iterative pseudo labeling (IPL)~\parencite{xu_iterative_2020}, 
slimIPL~\parencite{likhomanenko_slimipl_2021}, noisy student~\parencite{park_improved_2020}). These approaches are visualized in black. Also, note that the current state of the art---conformer XXL + noisy student~\parencite{zhang_pushing_2020}---is a combination of self-training and SSL techniques. Given the
