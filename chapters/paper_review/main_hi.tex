...
\begin{table*}[t]
    ...
    \begin{tabular}{lcccccc}
        ...
        Conformer L~\cite{gulati_conformer_2020} & - & LSTM & - & - & 1.9 & 3.9 \\
        ...
        wav2vec 2.0 \textsc{Large}~\cite{baevski_wav2vec_2020} & LL-60k & Transformer & 1.6 & 3.0 & 1.8 & 3.3 \\
        pre-trained Conformer XXL~\cite{zhang_pushing_2020} & LL-60k & LSTM & 1.5 & 3.0 & 1.5 & 3.1 \\
        ...
        pre-trained Conformer XXL + Noisy Student~\cite{zhang_pushing_2020} & LL-60k & LSTM & 1.3 & 2.6 & 1.4 & 2.6 \\
