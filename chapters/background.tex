...
\footnote{\label{fn:dimensional-analysis-of-differential-entropy}
    ...
    Following this interpretation, the discrete information entropy in \cref{eq:information-entropy} is also dimensionless, since a probability mass function is dimensionless. 
