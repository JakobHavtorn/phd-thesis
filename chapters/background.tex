...
\todo[inline]{Briefly hold the readers hand and tell them why VAEs are relevant to the overarching project.}
...
\todo[inline]{Finish this with the parsimony gap}
...
\todo[inline]{Derive and introduce the IWAE bound.}
