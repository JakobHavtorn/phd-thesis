...
% VAEs can be extended to hierarchical models by introducing additional latent variables $\zb_1,\dots,\zb_L$ that are conditionally dependent on each other \cite{ranganath_hierarchical_2016,sonderby_ladder_2016,vahdat_nvae_2020,child_very_2021,maaloe_biva_2019}. The generative model can then be written as,
% %
% \begin{equation}
%     p_\thetab(\xb,\zb_1,\dots,\zb_L) = p_\thetab(\xb|\zb_1)\prod_{l=2}^L p_\thetab(\zb_{l-1}|\zb_{l}) \enspace .
% \end{equation}
% %
