...
\texticite{xiao_we_2021} propose to use an existing, strong foundation model, pre-trained with a self-supervised objective, to extract features from the input, fit a parametric density estimator to the features and use the Mahalanobis distance as the OOD score. 
