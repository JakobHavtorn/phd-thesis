...
The work in \textcite{wenstrup_retrospective_2023} focuses on predictive performance and an analysis of feature importance but does not explicitly consider uncertainty estimation. To 
...
\begin{figure}
    ...
    \end{subfigure}
    \caption[Calibration curve for the uncalibrated stroke recognition model and empirical distribution of predicted probabilities.]{\subref{fig_discussion:calibration_curve_ensemble_and_all_models_uncalibrated} \Cref{fig_discussion:calibration_curve_ensemble_and_all_models_uncalibrated} shows the calibration curve for the uncalibrated ensemble model with median F1-score also reported in \cref{tab_retrospective:table3-occlusion-analysis} and \cref{fig_retrospective:figure1-roc-curve}. \subref{fig_discussion:histogram_ensemble_and_single_model} Histogram of predicted probabilities.}
\end{figure}
