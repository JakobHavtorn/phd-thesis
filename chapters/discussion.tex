...
Though more than three years have passed since the start of this project, the rapid development of machine learning that started about a decade ago with the ImageNet competation and the work of \textcite{krizhevsky_imagenet_2012} did all but slow down. In this section we will briefly revisit selected chapters of the thesis and provide some additional thoughts and discussion 
