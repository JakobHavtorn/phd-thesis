...
First, variational autoencoders are trained to maximize the ELBO which is a marginal likelihood objective that is conditionally independent of the latent variables $\zb$. Second, as we saw in \cref{eq:variational-autoencoder-elbo-factorized-expected}, the ELBO contains a hidden 
