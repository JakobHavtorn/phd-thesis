...
Since each study was written without consideration to the other chapters of this thesis, we here detail them in relation to the overall research project. 
This constitutes the research hypotheses and the contributions of the thesis.
...
An extended version of this overview paper that focuses exclusively on self"=supervised methods was also published as part of the project \ref{enumerate: paper-review} \parencite{mohamed_selfsupervised_2022} and is included in \cref{app:paper-review} for reference.
