...
\todo[inline]{Revise the location of the benchmarking paper and change the SSL review to the SSL+LVM brief review. Revise the text here accordingly.}
...
\todo[inline]{Edit this if we did not discuss this.}
