...
However, as such decisions impact critical aspects of human health and well-being, this prospect also raises concerns related to the reliability of systems that use artificial intelligence \parencite{chen_ethical_2021, shailaja_machine_2018, ahmad_interpretable_2018}.

The evolution of technology to support decision-making can be traced back to very beginning of recorded history. After the agricultural revolution, several ancient civilizations developed mathematical techniques and algorithms to help them manage the newfound complexity of pre-modern society. 
Fittingly, the earliest human whose name is known to recorded history was a Sumerian accountant called Kushim. Their signature has been identified on at least 18 clay tablets that deal with transactions and inventory of barley and other ingredients for beer production \parencite{nissen_archaic_1993}. 
...
In a likely attempt to reduce the effort needed to do Sumerian mathematics, Kushim produced a clay tablet with a multiplication table including fractional representations of common numbers. Assumedly unbeknownst to Kushim, this tablet would also come to contain one of the world's first recorded examples of a mathematical error; the statement: $5 \times \dfrac{1/2} = 5$ \parencite{nissen_archaic_1993}.
The Plimpton 322 clay tablet (\cref{fig:plimpton_332}) contains several errors in its list of Pythagorean triplets, presumably made by a novice in Babylonian mathematics \parencite{neugebauer_mathematical_1945,britton_plimpton_2011}. 
% Apart from such inherent limitations of the tools, inadequate human proficiency in their use was also a source of error. 
Besides these human errors, inherent limitations of the tools also posed problems. 
Babylonian mathematicians did not formalize the difference between rational and irrational numbers which lead to approximation errors. For instance, the common practice of approximating $\pi$ with 3 \parencite{georges_universal_2001}. 
