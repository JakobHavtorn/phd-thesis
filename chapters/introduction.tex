...
Fittingly, the first recorded human name in written history belonged to Kushim, a Sumerian accountant. Their signature has been identified on at least 18 clay tablets dated to 3400-3000 BCE, which document transactions and inventory related to barley and other ingredients used in beer production \parencite{nissen_archaic_1993}. 
...
Later, the scribe of the Plimpton 322 clay tablet (\cref{fig:plimpton_332}) made several errors when listing Pythagorean triplets, presumably struggling to grapple with Babylonian mathematics \parencite{neugebauer_mathematical_1945,britton_plimpton_2011}. 
...
This forced significant approximation errors, for instance the common practice of approximating $\pi$ with 3 \parencite{georges_universal_2001}. 
