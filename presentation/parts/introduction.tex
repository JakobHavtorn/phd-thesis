...
\begin{frame}
    ...
    \note[item]{Machine learning for healthcare can touch on most of these aspects. \cite{abati_conditional_2020}}
\end{frame}
...
\begin{frame}[t]
    \frametitle{Medical dialogue - a challenging domain}
    \begin{columns}[t]
...
\begin{frame}
    ...
    \note[item]{Adverse events are a leading cause of medical error.}
    \note[item]{But many of these are preventable.}
\end{frame}
...
\begin{frame}
    ...
    % \note[item] Another aspect of medical communication is documentation.
    % \note[item] This is a central part of healthcare.
