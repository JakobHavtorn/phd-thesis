...
\begin{frame}
    ...
    \note{
        \begin{enumerate}
            \item Examine how a certain class of generative models can be used to detect data that is different from training data. 
            \item Generalize this to be model-agnostic and phrased as a statistical test.
            \item Step back and provide an overview of modern methods for unsupervised speech representation learning.
            \item Benchmark some of these methods, generative latent variable models, on likelihood and automatic speech recognition.
            \item Move to a different domain, medical coding, and provide a critical review of recent works.
            \item Provide a retrospective study on a machine learning-assisted stroke recognition system for medical helpline calls.
        \end{enumerate}
    }
\end{frame}
