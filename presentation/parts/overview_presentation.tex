...
\begin{frame}
    ...
    \note[item]{So how does the thesis tackle this problem of building such a system?}
    \note{
        \begin{itemize}
            \item [Chp. 4] Examine how a certain class of generative models can be used to detect data that is different from training data. 
            \item [Chp. 5] Generalize this to be model-agnostic and phrased as a statistical test.
            \item [Chp. 6] Step back and provide an overview of modern methods for unsupervised speech representation learning.
            \item [Chp. 7] Benchmark some of these methods, generative latent variable models, on likelihood and automatic speech recognition.
            \item [Chp. 8] Move to a different domain, medical coding, and provide a critical review of recent works.
            \item [Chp. 9] Provide a retrospective study on a machine learning-assisted stroke recognition system for medical helpline calls.
        \end{itemize}
    }
    \end{frame}
...
\begin{frame}
    ...
    \note[item]{We want to keep papers that represent each of the three main themes of the thesis: (Uncertainty estimation, representation learning, and clinical applications)}
\end{frame}
